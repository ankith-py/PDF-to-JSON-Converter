                ...
                if content_type == 'application/pdf':
                    ...
                    try:
                        ...
                        if extracted_sections:
                            ...
                            return render_template('output_error.html', message="No text content extracted from the HTML.")
                    except Exception as e:
                        print("Error processing HTML content:", e)
                        return render_template('output_error.html', message="Error processing HTML content.")

                else:
                    return render_template('output_error.html', message="Unsupported content type.")

            except requests.exceptions.RequestException as req_exc:
                print("Request error:", req_exc)
                return render_template('output_error.html', message="Error fetching URL content.")
